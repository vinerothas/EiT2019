...
public class DataPlot {
    ...
    public static void plot(Stage stage, Bean bean) {
        ...
        Double[] acc = bean.acc.toArray(new Double[0]);
        Double[] ultr = bean.ultr.toArray(new Double[0]);
        Double[] ditemp = bean.ditemp.toArray(new Double[0]);
        Double[] antemp = bean.antemp.toArray(new Double[0]);
        Double[] pir = bean.pir.toArray(new Double[0]);
